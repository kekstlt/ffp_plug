...
"arm-linux-thread-multi-64int-2.6.35.11" or
	die "Errno architecture (arm-linux-thread-multi-64int-2.6.35.11) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
